    ...
    if (needsDetail.length > 0) {
      ...
      try {
        ...
        for (const rawId of needsDetail) {
          ...
          roster[key] = { ...roster[key], charges: detail.charges, priorBookings, totalBail, hasDetail: !!detail.complete };
          const logEntry = log.find(e => e.idnum === key);
          if (logEntry) Object.assign(logEntry, { charges: detail.charges, priorBookings, totalBail, hasDetail: !!detail.complete });
        }
      } catch (err) {
